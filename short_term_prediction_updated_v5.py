...
class dataInterpreter(object):
    ...
    def preprocess_data(self):
        self.processed_path = self.data_path + "./dataset/processed_endomondoHR_proper_interpolate_1k.csv"    
...
class da_rnn:
    ...
    def predict(self, id):
        predict_reader = dataInterpreter_predict(self.T, self.inputAtts, self.includeUser, self.includeSport, 
                                           self.includeTemporal, self.targetAtts, trimmed_workout_len=self.trimmed_workout_len, 
...
class dataInterpreter_predict(object):
    ...
    def preprocess_data(self, id):
        self.processed_path =  "./dataset/processed_endomondoHR_proper_interpolate_5k.csv"
